...
public class WinerScreen implements Screen {
	...
	public WinerScreen(MyGame game,SpriteManager manager) {
		this.game = game;
	...
	private void loadScreen() {
        ...
        // Etiqueta de texto
        Label label = new Label("Victoria", game.getSkin());
        label.setFontScale(2.5f);
        Label label1 = new Label("Si quieres jugar otra partida pulsa la tecla 'N'", game.getSkin());
        label.setFontScale(2.5f);
        Label label3 = new Label("puntuacion", game.getSkin());
        label3.setFontScale(2.5f);
        Label label4 = new Label(String.valueOf(manager.hud.puntuacion), game.getSkin());
        label3.setFontScale(2.5f);
        ...
        table.row().height(40);
        table.add(label3).center().pad(35f);
        table.add(label4).center().pad(35f);
        table.row().height(40);
